...
# CARHO <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
-   [`DESCRIPTION`](https://github.com/guilhemmarre/CARHO/tree/master/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/guilhemmarre/CARHO/tree/master/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/guilhemmarre/CARHO/tree/master/R):
...
Guidelines](https://github.com/guilhemmarre/CARHO/blob/main/CONTRIBUTING.md).
